...
<link href="/resources/include/assets/dist/css/bootstrap.min.css"
	rel="stylesheet">
...
<link href="/resources/include/css/sign-in.css" rel="stylesheet">
</head>
<body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
		<c:if test="${empty adminLogin}">
			<form id="loginForm">
				<!--     <img class="mb-4" src="resources/include/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">
	 -->
				<h1 class="h3 mb-3 fw-normal">관리자 로그인 페이지</h1>

				<div class="form-floating">
					<input type="text" class="form-control" id="adminId" name="adminId"
						placeholder="Admin ID"> <label for="adminId">Admin
						ID</label>
				</div>
				<div class="form-floating">
					<input type="password" class="form-control" id="adminPasswd"
						name="adminPasswd" placeholder="Admin Password"> <label
						for="adminPasswd">Admin Password</label>
				</div>
	 ...
	 -->
		...
		<c:if test="${not empty adminLogin}">
			<h3>${adminLogin.adminName}님환영합니다.</h3>
