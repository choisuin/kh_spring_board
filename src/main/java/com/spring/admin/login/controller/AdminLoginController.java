...
public class AdminLoginController {
	...
	@PostMapping("login")
	public String loginProcess(AdminLoginVO lgoin, Model model, RedirectAttributes ras) {
		AdminLoginVO adminLogin = adminLoginService.loginProcess(lgoin);
